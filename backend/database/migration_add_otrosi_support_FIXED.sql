-- Migration: Add Otrosí Contract Type Support (FIXED VERSION)
...
BEGIN
    ...
    ELSE
        ...
        VALUES (current_year, p_contract_type, next_sequence, NOW());
    END IF;
...
-- Verify contract_generations has contract_type column
-- SELECT column_name, data_type FROM information_schema.columns
-- WHERE table_name = 'contract_generations' AND column_name IN ('contract_type', 'approved_document_url');

-- ================================================================
-- ROLLBACK INSTRUCTIONS (if needed)
-- ================================================================

-- To rollback this migration, run: backend/database/rollback_otrosi_support.sql
