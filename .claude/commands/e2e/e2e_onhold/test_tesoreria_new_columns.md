# E2E Test: Tesorería New Columns (Subsidiary & Retencion)

Test that the "Aplicacion de Pagos CO" output file includes the new subsidiary and retencion_en_fuente columns.
...
**Location**: `.claude/commands/e2e/fixtures/test_historial_pagos_co_with_retencion.xlsx`
...
- **NEW**: Retención column with value (e.g., 15000.00)
...
|---------|---------------------------|---------------------|-------------------|---------------|--------|---------|-----------------|---------------------|-----------|------------------|
| Test Client 1 | 900111222 | CO:900111222:1:1:PAG | REC-001 | 2025-12-01 | COP | 1000000 | Banco Test | 50000 | 15000 | 60100001091 |
| Test Client 2 | 900333444 | CO:900333444:1:1:PAG | REC-002 | 2025-12-02 | COP | 2000000 | Banco Test | 0 | 0 | 60100001091 |
...
3. Take a screenshot of the Colombia converter page

4. **Verify** Colombia converter page loads with file upload area
...
1. Output Excel file has 16 columns (previously 14)
2. Column 15 is named "subsidiary" with value 4 on EVERY row
...
5. When source row expands to multiple output rows (e.g., CAPITAL + INTERESES):
   - subsidiary=4 appears on ALL expanded rows
...
- The "first row only" pattern for retencion follows the same logic as comision_banco (México)
